      ...
      <div className="col-12 d-flex p-4 justify-content-around homebg align-items-center">
        ...
        <Carousel className="col-3 d-flex jutity-content-center align-items-center">
            <Carousel.Item className="logo">
              <img className="img-fluid" src="https://img.freepik.com/free-vector/golden-elegant-logo-with-frame_52683-13462.jpg?w=740&t=st=1680077796~exp=1680078396~hmac=3b1ad707d506d771ec315abf26634abcadb6cdafd1b4e8338a475b97d57b7b64" alt="women" />
            </Carousel.Item>
            <Carousel.Item className="logo">
              <img className="img-fluid" src="https://img.freepik.com/free-vector/golden-elegant-logo-template_23-2148219501.jpg?w=740&t=st=1680077730~exp=1680078330~hmac=4a4bf1fe853707d0dbb134fcacadd24830239827d9dea15946e7a777d7cd7cfb" alt="men" />
            </Carousel.Item>
            <Carousel.Item className="logo">
              <img className="img-fluid" src="https://img.freepik.com/free-vector/letter-k-logo-concept-your-royal-brand_1017-33266.jpg?w=740&t=st=1680077438~exp=1680078038~hmac=7132959350eac1babf0d33307f600eaf28e295eefd473c7151e05e74236614f4" alt="kid" />
            </Carousel.Item>
            <Carousel.Item className="logo">
              <img className="img-fluid" src="https://img.freepik.com/free-vector/la-mode-logo_23-2147523555.jpg?w=740&t=st=1680077868~exp=1680078468~hmac=abdeeec657532616c25b53fecc4b6be84b1d4499e6bd8b3d6889ccb342c9e965" alt="women" />
            </Carousel.Item>  <Carousel.Item className="logo">
              <img className="img-fluid" src="https://img.freepik.com/free-vector/gradient-hair-salon-logo-template_23-2148881845.jpg?w=740&t=st=1680077894~exp=1680078494~hmac=1e2db30920003afd99bbd7cc9d1c69c5676cf8b99196b4659c1aaba1a6ddb6c9" alt="women" />
            </Carousel.Item>  <Carousel.Item className="logo">
              <img className="img-fluid" src="https://img.freepik.com/free-vector/hand-drawn-clothing-store-logo-design_23-2149577874.jpg?w=740&t=st=1680077939~exp=1680078539~hmac=7ba69053f8a49532df9fa60846673c339e08039267551434ee6a32cac02187fe" alt="women" />
            </Carousel.Item>  <Carousel.Item className="logo">
              <img className="img-fluid" src="https://img.freepik.com/free-vector/golden-elegant-corporative-logo-template_23-2148214854.jpg?w=740&t=st=1680078401~exp=1680079001~hmac=bc326f374a1a695ce1b5d68d8ea80429d1e8f9482c7cf06ad8162506f91e3a72" alt="women" />
            </Carousel.Item>  <Carousel.Item className="logo">
              <img className="img-fluid" src="https://img.freepik.com/free-vector/hand-drawn-woman-logo-avatar_23-2148849507.jpg?w=740&t=st=1680078439~exp=1680079039~hmac=5c5e6213509abfbca3a31a3aef8aaf80c6a8ae704a6394a0b3ae202bf7f9a95e" alt="women" />
            </Carousel.Item>  <Carousel.Item className="logo">
              <img className="img-fluid" src="https://img.freepik.com/free-vector/flat-design-clothing-logo-template_23-2149489910.jpg?size=626&ext=jpg&uid=R61188314&ga=GA1.2.1329435010.1679413996&semt=ais" alt="women" />
            </Carousel.Item>  <Carousel.Item className="logo">
              <img className="img-fluid" src="https://img.freepik.com/premium-vector/minimal-fashion-shop-logo_278222-2028.jpg?size=626&ext=jpg&uid=R61188314&ga=GA1.2.1329435010.1679413996&semt=ais" alt="women" />
            </Carousel.Item>
          </Carousel>
        </div>
    </>
