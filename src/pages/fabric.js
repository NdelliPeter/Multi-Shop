...
export default function Fabric() {
  ...
  const price1 = (e) => {
    ...
    if (e.target.checked) {
      axios.get(`http://localhost:4000/filter/fabric`, { params: { range: range } })
        .then((res) => {
  ...
  const fabric = products?.filter((prod) => (prod.category === 'fabric'))


  console.log('poijfkdfndlfkndflknfd', fabric);
